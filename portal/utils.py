...
def get_student_info(request, admission_no):
    ...
    latest_version = get_object_or_404(Version, version_count=student.version_count, student=student)
    ...
    return {"student": info, "records": records, "admission_no": admission_no, "versions": version_values, "cur_ver": version.version_count, "user": version.curr_user, "date": version.date, "lock": latest_version.lock}
